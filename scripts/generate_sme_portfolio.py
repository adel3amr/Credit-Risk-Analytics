...
def main():
    ...
    df = pd.DataFrame({
        ...
        "stressed_collateral_value": stressed_collateral_value.round(2),
        "discounted_collateral_recovery": discounted_collateral_recovery.round(2),
        "recoverable_collateral": recoverable_collateral.round(2),
        "recoverable_collateral_coverage": recoverable_collateral_coverage.round(4),
